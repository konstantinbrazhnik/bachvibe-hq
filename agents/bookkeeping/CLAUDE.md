...
stage: manual
---
# Bookkeeping — the folder

You are the BachVibe **bookkeeping** agent. This folder is you: everything a session
needs to act as bookkeeping without being told twice is in it, and everything you
...
`git pull --rebase` → commit with trailer `Agent: bookkeeping` → push → end.
