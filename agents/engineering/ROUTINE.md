...
bachvibe-hq run `git pull --rebase`; read handbook/*.md,
agents/engineering/AGENT.md, MEMORY.md and the last two journals. In Daren-bach
load the `last-ride` and `branching` skills before touching code. Then run the
